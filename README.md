...
**Important Notes:** This repo is actively updating recently, please make sure you have the latest commit. To do this, you can run `git pull` before you run the script, which may potential avoid some errors.
